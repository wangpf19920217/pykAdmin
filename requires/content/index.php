<div class="admin-content am-padding">
	...
	为基础
	<br />
	注:如需要注释 添加类 <code>.help </code> 在当前元素上加<code>title=“要表述的文字”</code>
	<br />
	例子:
	<div class="help" title="这是一个div">
		这是什么？
	</div>
	<div class="am-progress am-progress-striped am-progress-sm am-active">
		<div class="am-progress-bar am-progress-bar-success" style="width: 12%">
			12%
		</div>
	</div>
	<div class="am-progress">
		<div class="am-progress-bar" style="width:23.8%" data-am-popover="{content: '', trigger: 'hover focus'}">
			周一
		</div>
		<div class="am-progress-bar am-progress-bar-secondary" data-am-popover="{content: '', trigger: 'hover focus'}" style="width:24.5%">
			周二
		</div>
		<div class="am-progress-bar am-progress-bar-success" style="width:9.5%" data-am-popover="{content: '', trigger: 'hover focus'}">
			周三
		</div>
		<div class="am-progress-bar am-progress-bar-warning" style="width:8.2%" data-am-popover="{content: '', trigger: 'hover focus'}">
			周四
		</div>
		<div class="am-progress-bar am-progress-bar-danger" style="width:34%" data-am-popover="{content: '', trigger: 'hover focus'}">
			周五
		</div>
	</div>
	<ol>
