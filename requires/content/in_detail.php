			...
			<div class="am-collapse am-topbar-collapse" id="topbar-collapse">
				<nav class="scrollspy-nav " style="right: 0;" data-am-scrollspy-nav="{className: {active: 'am-active'}}" data-am-sticky>
				  <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right ">
				    <li class=""><a href="#xinxi">信息</a></li>
				    <li class=""><a href="#tongji">统计</a></li>
				    <li class=""><a href="#liebiao">列表</a></li>
				    <li class=""><a href="#guanyu">关于</a></li>
				    <li class=""><a href="#qita">其他</a></li>
				  </ul>
			</nav>			
</div>
		</header>
<div class="admin-content am-padding" >
	<div class="am-panel am-panel-default" id="xinxi">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-1'}">个人信息/基本信息<span class="am-icon-chevron-down am-fr"></span></div>
          <div class="am-panel-bd am-collapse am-in" id="collapse-panel-1">
	            <table class="am-table">
					    ...
					    <tbody>
					        <tr>
					            <td>1</td>
					            <td><a href="#tongji">详细</a></td>
					            <td><button class="am-btn">操作</button></td>
					        </tr>
					        <tr>
					            <td>2</td>
					            <td><a href="#tongji">详细</a></td>
    ...
    <div class="am-panel am-panel-default"  id="tongji">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-2'}">他/她的资料<span class="am-icon-chevron-down am-fr"></span></div>
          <div class="am-panel-bd am-collapse am-in" id="collapse-panel-2">
	            <?php
					include_once('requires/content/details/x.php');	//主页引导
				?>
          </div>
    </div>
    ...
    <div class="am-panel am-panel-default" id="liebiao">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-3'}">个人信息/基本信息<span class="am-icon-chevron-down am-fr"></span></div>
    ...
    <div class="am-panel am-panel-default" id="guanyu">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-4'}">个人信息/基本信息<span class="am-icon-chevron-down am-fr"></span></div>
    ...
    <div class="am-panel am-panel-default" id="qita">
          <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-5'}">个人信息/基本信息<span class="am-icon-chevron-down am-fr"></span></div>
	...
	<div class="am-panel am-panel-default" ><div class="am-panel-hd">再见王子</div><div class="am-panel-bd"><p>来自街头的声音。飘浮在城市天空的“棉花糖”。 柔软却刚强，义无反顾地行进。 棉花糖[katncandix2] 小球+圣哲 第2张全创作专辑 [再见王子] 再见梦想。再见初恋。再见泪水。再见昨天。 必须向天真的自己说再见，才能勇敢地冒险找到未来。 幻灭之后的蜕变，是重生的那一刻。 “小飞行”好评后 严选《再见王子》《好日子》《怎么说呢?》《回不去的旅人》 全新格局 10篇刻印成长的青春创作 词+曲+创作+制作+演唱 棉花糖 棉花糖的音乐形成自成一格的清透感 。</p></div></div>
	<div class="am-panel am-panel-default" ><div class="am-panel-hd">第三张</div><div class="am-panel-bd"><p>一切看似美好的过程之中，有许多不同却深刻的故事，跟随着生命和宇宙的运行发生中。悲伤的、快乐的时常已无以名状。棉花糖将过程中产生的讯息，刻划成专辑里的十一首歌曲。棉花糖此时还能笑着说这张专辑：「我们走进了黑暗的入口，开始寻找希望与光明，当真正找到了透进光线的出口并走出时，我们早已伤痕无数、甚至被种植黑暗，热情是唯一能抵抗的道具。」我说，那是一段不被了解的路程。</p><p>每个人都是不被了解的怪人，你/你的与众不同，其实与众相同。也许将自我置放在一个不被了解的过程中，才能真正面对前所未见的情感释放与获得。再确认一次：你/你的与众不同，其实与众相同。</p></div></div>
</div>
